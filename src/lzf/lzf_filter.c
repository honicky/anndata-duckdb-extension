...
static const H5Z_class_t filter_class = {
    H5Z_CLASS_T_VERS,        (H5Z_filter_t)(H5PY_FILTER_LZF), 1, 1, "lzf", NULL, (H5Z_set_local_func_t)(lzf_set_local),
    (H5Z_func_t)(lzf_filter)};
#else
static const H5Z_class_t filter_class = {(H5Z_filter_t)(H5PY_FILTER_LZF), "lzf", NULL,
